...
class Plot extends React.Component {
  ...
  render() {
    ...
    if (domains) {
      ...
      domainsNames = domainsNames.map((val) => (
    ...
    return (
      <div style={{ width: "100%" }}>
        <Row style={{ width: "100%" }}>
            ...
            <Card title="Plot settings" className="Card-input">
              <Row className="Plot-Settings-Row">
                ...
                <div>
                  ...
                  >
                    <Radio.Button value="fusionProtein">
                      {"Fusion"}
                    </Radio.Button>
                    <Radio.Button value="gene1Protein">
                      {"5' gene"}
                    </Radio.Button>
                    <Radio.Button value="gene2Protein">
                      {"3' gene"}
                    </Radio.Button>
                  </Radio.Group>
                </div>
          ...
          <Col xs={24} xl={16} ref={this.divRef}>
                ...
                <Fragment>
                  <Layer ref={imageRef}>
                    ...
                    {plotData.rects.map((rect) => {
                      ...
                      var color = domainColors[rect.shortName]
                        ? domainColors[rect.shortName]
                        : rect.color;
  ...
  _handleRadioChange = (e) => {
    if (
      ["fusionProtein", "gene1Protein", "gene2Protein"].includes(e.target.value)
    ) {
      this.setState({
  ...
  _downloadImage = () => {
    ...
    if (plotTypeProtein === "fusionProtein" && plotDataAll.fusionProtein) {
      plotName =
        plotDataAll.fusionProtein.transcript.name.replace(" : ", "__") +
        ".fusion-protein.png";
    } else if (plotTypeProtein === "gene1Protein" && plotDataAll.gene1Protein) {

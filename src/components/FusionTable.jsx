    ...
    const columns = [
      {
        ...
        width: "20%",
        filters: [
          ...new Set(fusionIsoforms.map((val) => val.transcript1.geneName)),
        ].map((val) => {
          return { text: val, value: val };
        }),
        onFilter: (value, record) =>
          record.transcript1.geneName.indexOf(value) === 0,
      },
      {
        title: "3' gene",
        dataIndex: "displayData",
        ...
        width: "20%",
        filters: [
          ...new Set(fusionIsoforms.map((val) => val.transcript2.geneName)),
        ].map((val) => {
          return { text: val, value: val };
        }),
        onFilter: (value, record) =>
          record.transcript2.geneName.indexOf(value) === 0,
      },
      {
